...
real_file_loc = os.path.dirname( os.path.abspath( __file__ )) + '/../emsdk/emsdk/upstream/emscripten/tools/file_packager.py'

sys.path.insert(1, os.path.dirname(os.path.dirname(os.path.abspath( real_file_loc ))))
